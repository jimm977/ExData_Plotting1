...
## Plotting part
png(file="i:\\CourserA\\_RStudio_WorkingDir\\1\\plot2.png", width = 480, height = 480)

plot(dTab$Time, dTab$Gl_act_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
